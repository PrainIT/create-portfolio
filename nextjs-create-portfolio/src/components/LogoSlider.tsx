    ...
    <section className="w-full bg-[#1A1A1A] py-12 border-b border-grey-800">
      ...
      <div className="flex flex-row items-center items-start mt-12">
        <div className="flex flex-col gap-12">
          <div className="text-3xl font-medium ">함께하면 더 좋은 일들,<br/>편하게 연락해주세요!</div>
          <div className="flex flex-row gap-4">
            <div className="text-grey-400 text-xl font-medium whitespace-nowrap">{logos[0].text}</div>
            <div className="text-grey-400 text-xl font-medium whitespace-nowrap">{logos[1].text}</div>
            <div className="text-grey-400 text-xl font-medium whitespace-nowrap">{logos[2].text}</div>
          </div>
        </div>
        <div className="flex flex-col gap-8 ml-32">
          <div className="text-base text-grey-400">서로의 강점을 신뢰하며 아이디어를 확장시킵니다.<br/>각자의 전문 분야가 하나의 완성된 결과로 자연스럽게 이어집니다.<br/>혼자보다 함께할 때 더 뛰어난 크리에이티브를 만들어냅니다.</div>
          <button className="bg-brand text-white px-2 py-4 rounded-full min-w-40 w-[200px] hover:opacity-80 transition-all duration-300">CONTACT</button>
        </div>
      </div>
